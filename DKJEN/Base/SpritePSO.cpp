...
SpritePSO* SpritePSO::GetInstance()
{
	static SpritePSO instance;

	return &instance;
}
void SpritePSO::CreatePSO()
{
	ShapePSO();
}

void SpritePSO::Release()
{
	if (SpritePSO::GetInstance()->pso_.Texture.errorBlob)
	{
		SpritePSO::GetInstance()->pso_.Texture.errorBlob->Release();
	}
	SpritePSO::GetInstance()->pso_.Texture.GraphicsPipelineState->Release();
	SpritePSO::GetInstance()->pso_.Texture.rootSignature->Release();
	SpritePSO::GetInstance()->pso_.Texture.signatureBlob->Release();
}

void SpritePSO::ShapePSO()
{
	...
	SpritePSO::GetInstance()->pso_.Texture = ShapePSO;
